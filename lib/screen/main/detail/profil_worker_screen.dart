...
class _ProfilWorkerScreenState extends State<ProfilWorkerScreen> with TickerProviderStateMixin {
  late TabController _tabController;

  @override
  void initState() {
    super.initState();
    _tabController = TabController(length: 4, vsync: this); // Trois onglets
  }
  @override
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                ...
                spacing: 8,
                children: [
                  mediumTextApp("Elijah Walter", context),
                  Row(
                    spacing: 8,
                    children: [
